...
class SadVoiceTrigger:
    ...
    def update(
        ...
        if sad_visible:
            ...
            certain = expression.confidence >= self.instant_confidence
    ...
    try:
        with Reader("camera.rect", keeptime=False) as camera, \
            ...
            while not args.max_frames or frame_count < args.max_frames:
                ...
                sad_leaning = leans_sad(expression)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.85,
        help="confidence that starts the check-in without waiting out the hold",
    )
